    ...
    namespace Plugin
    {
        ...
        bool updateIPSettings(DbusMgr& m_dbus, const std::string& connectionPath, const Exchange::INetworkManager::IPAddress& address, const std::string& interface)
        {
            ...
            if(!address.autoconfig)
            {
                ...
                g_variant_builder_add(&addressEntryBuilder, "u", GnomeUtils::ip4_str_to_nbo(address.gateway));
                ...
                g_variant_builder_add(&dns_builder, "u", GnomeUtils::ip4_str_to_nbo(address.primarydns));
                g_variant_builder_add(&dns_builder, "u", GnomeUtils::ip4_str_to_nbo(address.secondarydns));
        ...
        bool NetworkManagerClient::getIPSettings(const std::string& interface, const std::string& ipversion, Exchange::INetworkManager::IPAddress& result)
        {
            ...
            guint32 prefix = 0;
            const gchar *gatewayIp = NULL;
            gchar *dhcpServerIp = NULL;
            gchar **dnsList = NULL;
            gchar *ip4ConfigPath = NULL;
            gchar *dhcp4ConfigPath = NULL;
            gchar *dnsAddresses = NULL;
            gchar *dhcp6ConfigPath = NULL;
